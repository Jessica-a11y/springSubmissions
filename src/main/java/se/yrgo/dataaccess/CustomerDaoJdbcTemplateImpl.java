...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao{
    ...
    public void createTables() {
        try {
            ...
            template.update("CREATE TABLE TBL_CALL (ID integer generated by default as identity (start with 1), TIME_AND_DATE TIMESTAMP, NOTES VARCHAR(100))");
        } catch(org.springframework.jdbc.BadSqlGrammarException e) {
            System.out.println("Tables CUSTOMER and/or CALL already exists");
        } 
    }
